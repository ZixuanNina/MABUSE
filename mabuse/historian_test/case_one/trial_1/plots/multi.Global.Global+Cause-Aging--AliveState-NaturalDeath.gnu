# Global
# Global+Cause_Aging__AliveState_NaturalDeath|Ave
# Global+Cause_Aging__AliveState_NaturalDeath|Std
set terminal postscript eps size 7.0,5.0 enhanced color;
set output 'multi.Global.Global+Cause-Aging--AliveState-NaturalDeath.eps';
...
plot "multi.Global.Global+Cause-Aging--AliveState-NaturalDeath.dat" u ($1/365):2 with linespoints ls 1 t "Ave", 
