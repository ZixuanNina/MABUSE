# Global Global+Cause_HCV__HCV_Chronic_State|Ave
set terminal postscript eps size 7.0,5.0 enhanced color font 'Helvetica,20' linewidth 2;
set output 'Global.Global+Cause-HCV--HCV-Chronic-State-Ave.eps';
...
plot "Global.Global+Cause-HCV--HCV-Chronic-State-Ave.dat" u ($1/365):2 with linespoints ls 1 t "Ave ;
