# Place Place+Population=default_place
set terminal postscript eps size 7.0,5.0 enhanced color font 'Helvetica,20' linewidth 2;
set output 'Place.Place+Population=default-place.eps';
...
plot "Place.Place+Population=default-place.dat" u ($1/365):2 with linespoints ls 1 t "default_place ;
