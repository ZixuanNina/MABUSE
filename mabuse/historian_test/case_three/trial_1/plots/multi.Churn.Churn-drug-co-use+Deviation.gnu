# Churn
# Churn:drug_co_use+Deviation|Ave
# Churn:drug_co_use+Deviation|Std
set terminal postscript eps size 7.0,5.0 enhanced color;
set output 'multi.Churn.Churn-drug-co-use+Deviation.eps';
...
plot "multi.Churn.Churn-drug-co-use+Deviation.dat" u ($1/365):2 with linespoints ls 1 t "Average ", 
