# Churn Churn:drug_co_use+AbsDeviation|Std
set terminal postscript eps size 7.0,5.0 enhanced color font 'Helvetica,20' linewidth 2;
set output 'Churn.Churn-drug-co-use+AbsDeviation-Std.eps';
...
plot "Churn.Churn-drug-co-use+AbsDeviation-Std.dat" u ($1/365):2 with linespoints ls 1 t "Std. deviation  ;
