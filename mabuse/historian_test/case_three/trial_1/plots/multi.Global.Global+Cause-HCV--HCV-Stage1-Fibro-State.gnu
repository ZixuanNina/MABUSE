# Global
# Global+Cause_HCV__HCV_Stage1_Fibro_State|Ave
# Global+Cause_HCV__HCV_Stage1_Fibro_State|Std
set terminal postscript eps size 7.0,5.0 enhanced color;
set output 'multi.Global.Global+Cause-HCV--HCV-Stage1-Fibro-State.eps';
...
plot "multi.Global.Global+Cause-HCV--HCV-Stage1-Fibro-State.dat" u ($1/365):2 with linespoints ls 1 t "Ave", 
