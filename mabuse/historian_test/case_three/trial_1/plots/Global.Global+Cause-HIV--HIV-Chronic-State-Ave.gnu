# Global Global+Cause_HIV__HIV_Chronic_State|Ave
set terminal postscript eps size 7.0,5.0 enhanced color font 'Helvetica,20' linewidth 2;
set output 'Global.Global+Cause-HIV--HIV-Chronic-State-Ave.eps';
...
plot "Global.Global+Cause-HIV--HIV-Chronic-State-Ave.dat" u ($1/365):2 with linespoints ls 1 t "Ave ;
