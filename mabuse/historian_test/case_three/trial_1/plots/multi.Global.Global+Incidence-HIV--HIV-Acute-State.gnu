# Global
# Global+Incidence_HIV__HIV_Acute_State|Ave
# Global+Incidence_HIV__HIV_Acute_State|Std
set terminal postscript eps size 7.0,5.0 enhanced color;
set output 'multi.Global.Global+Incidence-HIV--HIV-Acute-State.eps';
...
plot "multi.Global.Global+Incidence-HIV--HIV-Acute-State.dat" u ($1/365):2 with linespoints ls 1 t "Ave", 
