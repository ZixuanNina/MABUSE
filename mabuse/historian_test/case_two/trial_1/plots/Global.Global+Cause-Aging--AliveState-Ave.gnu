# Global Global+Cause_Aging__AliveState|Ave
set terminal postscript eps size 7.0,5.0 enhanced color font 'Helvetica,20' linewidth 2;
set output 'Global.Global+Cause-Aging--AliveState-Ave.eps';
...
plot "Global.Global+Cause-Aging--AliveState-Ave.dat" u ($1/365):2 with linespoints ls 1 t "Ave ;
