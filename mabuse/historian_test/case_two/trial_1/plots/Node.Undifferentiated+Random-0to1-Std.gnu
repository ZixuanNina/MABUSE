# Node Undifferentiated+Random_0to1|Std
set terminal postscript eps size 7.0,5.0 enhanced color font 'Helvetica,20' linewidth 2;
set output 'Node.Undifferentiated+Random-0to1-Std.eps';
...
plot "Node.Undifferentiated+Random-0to1-Std.dat" u ($1/365):2 with linespoints ls 1 t "Std ;
